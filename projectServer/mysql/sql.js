 ...
 * 新增文章
 */
exports.addArticle = "insert into article(title, author, type, description, time, content, submiter, submitTime, modifier, updateTime, user_id, is_public) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
 ...
 * 更新文章所有字段
 */
exports.updateArticle = "update article set title = ?, author = ?, type = ?, description = ?, time = ?, content = ?, is_public = ?, modifier = ?, updateTime = ? where id = ?";
